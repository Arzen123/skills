...
- **[dnp-clinical-sites](./dnp-clinical-sites/SKILL.md)** — Find candidate FNP/primary-care clinical placement sites in a California region and output them as a KML file for import into Google My Maps.
